                        ...
                        <View style={styles.centeredView}>
                            <View style={styles.modalView}>
                                ...
                                <View style={[{padding:20,}]}>
                                    <TouchableOpacity style={[{marginBottom:15,}]} onPress={() => {setModal(!modal); setAwal('Tanjung Priok')}}>
                                    ...
                                    <TouchableOpacity style={[{marginBottom:15,}]} onPress={() => {setModal(!modal); setAwal('Tanjung Perak')}}>
                                        <Text style={[{ fontSize:11,color:'#fff' }]}>
                                            Hujunggaluh
                                        </Text>
                                        <Text style={[{ fontSize:16,color:'#fff' }]}>
                    ...
                    >
                        <View style={styles.centeredView}>
                            <View style={styles.modalView}>
                                ...
                                <View style={[{padding:20,}]}>
                                    <TouchableOpacity style={[{marginBottom:15,}]} onPress={() => {setModal2(!modal2); setTujuan('Tanjung Priok')} }>
                                        <Text style={[{ fontSize:11,color:'#fff' }]}>
                                            Djakarta
                                        </Text>
                                        <Text style={[{ fontSize:16,color:'#fff' }]}>
                                    ...
                                    <TouchableOpacity style={[{marginBottom:15,}]} onPress={() => {setModal2(!modal2); setTujuan('Tanjung Perak')}}>
                                        <Text style={[{ fontSize:11,color:'#fff' }]}>
                                            Hujunggaluh
                                        </Text>
                                        <Text style={[{ fontSize:16,color:'#fff' }]}>
